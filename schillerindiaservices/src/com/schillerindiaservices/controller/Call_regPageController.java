    ...
    if(sArray.size()==1){
        ...
        individualSearch += sArray.get(sArray.size()-1);
         ...
         try
         {
             ...
             String sql = "SELECT COUNT(*) FROM callregister WHERE division='"+divName+"' AND status_type='Pending'";
...
//                 String sql1 = "SELECT * FROM " + table;
                 String sql1 = "SELECT * FROM callregister WHERE division='"+divName+"' AND status_type='Pending'";
...
//            ja.put(diffDays);
        ...
        String sql2 = "SELECT COUNT(*) FROM callregister WHERE division='"+divName+"' AND status_type='Pending'";
        if (searchTerm != "")
        {
            sql2 = sql2 + searchSQL;
