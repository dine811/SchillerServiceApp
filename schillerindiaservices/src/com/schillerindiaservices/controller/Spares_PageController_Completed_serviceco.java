 ...
 * @author ShineLoGics
 */
@WebServlet("/Spares_PageController_Completed_serviceco")
public class Spares_PageController_Completed_serviceco extends HttpServlet {
    ...
    if(sArray.size()==1){
        ...
        individualSearch += sArray.get(sArray.size()-1);
         ...
         try
         {
             ...
             String sql = "SELECT COUNT(*) FROM sparemaster WHERE  final_status='Completed'";
...
//                 String sql1 = "SELECT * FROM " + table;
                 String sql1 = "SELECT * FROM sparemaster WHERE  final_status='Completed'";
...
//            ja.put(diffDays);
        ...
        String sql2 = "SELECT COUNT(*) FROM sparemaster WHERE  final_status='Completed'";
        if (searchTerm != "")
        {
            sql2 = sql2 + searchSQL;
