    ...
    if(sArray.size()==1){
        ...
        individualSearch += sArray.get(sArray.size()-1);
         ...
         try
         {
             ...
             String sql = "SELECT COUNT(*) FROM pendingactmaster WHERE division='"+divName+"' AND status_type='pending'";
...
//                 String sql1 = "SELECT * FROM " + table;
                 String sql1 = "SELECT * FROM pendingactmaster WHERE division='"+divName+"' AND status_type='pending'";
...
//            ja.put(diffDays);
        ...
        String sql2 = "SELECT COUNT(*) FROM pendingactmaster WHERE division='"+divName+"' AND status_type='pending'";
        if (searchTerm != "")
        {
            sql2 = sql2 + searchSQL;
