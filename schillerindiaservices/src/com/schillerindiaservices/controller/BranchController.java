...
public class BranchController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet BranchController</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet BranchController at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
...
//        processRequest(request, response);
            ...
            Branch b=new Branch();
            b.setBranchid(Integer.parseInt(id));
            b.setBranchname(branchname);
            b.setBranchlocation(branchlocation);
            b.setBranchaddress(branchaddress);
            b.setBranchphone(branchphone);
            
            BranchDao dDao=new BranchDao();
        try {
            dDao.update(b);
