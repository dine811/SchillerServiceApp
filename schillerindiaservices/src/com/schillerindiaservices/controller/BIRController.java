    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        if(id==0)
        {
            try {
				...
				/*
				 * fqc_inward_date = uitlfn.getRev_DateFormat(fqc_inward_date); invoice_date =
				 * uitlfn.getRev_DateFormat(invoice_date); approved_date =
				 * uitlfn.getRev_DateFormat(approved_date); unit_inward_date =
				 * uitlfn.getRev_DateFormat(unit_inward_date); cnr_relese_date =
				 * uitlfn.getRev_DateFormat(cnr_relese_date); ts_team_verification_date =
				 * uitlfn.getRev_DateFormat(ts_team_verification_date);
				 * ps_team_verification_date =
				 * uitlfn.getRev_DateFormat(ps_team_verification_date);
				 */
