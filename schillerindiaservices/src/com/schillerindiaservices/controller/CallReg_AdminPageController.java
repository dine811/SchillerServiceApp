 ...
 * @author ShineLoGics
 */
public class CallReg_AdminPageController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet CallReg_AdminPageController</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet CallReg_AdminPageController at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    if(sArray.size()==1){
        ...
        individualSearch += sArray.get(sArray.size()-1);
         ...
         try
         {
             ...
             String sql = "SELECT COUNT(*) FROM callregister WHERE status_type='Pending'  ";
...
//                 String sql1 = "SELECT * FROM " + table;
                 String sql1 = "SELECT * FROM callregister WHERE status_type='Pending' ";
               ...
               String globeSearch = " where (engineer like '%" + searchTerm + "%'" +" or type_of_call like '%" + searchTerm + "%'" +" or status_type like '%" + searchTerm + "%')" + "" ;
...
//            ja.put(diffDays);
        ...
        String sql2 = "SELECT COUNT(*) FROM callregister WHERE status_type='Pending'  ";
        if (searchTerm != "")
        {
            sql2 = sql2 + searchSQL;
