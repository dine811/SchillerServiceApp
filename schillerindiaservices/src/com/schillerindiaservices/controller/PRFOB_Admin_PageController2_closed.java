 ...
 * @author ShineLoGics
 */
@WebServlet("/PRFOB_Admin_PageController2_closed")
public class PRFOB_Admin_PageController2_closed extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet PRFOB_Admin_PageController</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet PRFOB_Admin_PageController at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try
     {
         ...
         String[] cols = { "id","division", "entry_date","sc_engg","work_type","received_date","crm_ref_no","branch","engineer","model","warrenty_status","prfob_ref_no","executed_date","status_type"};
    ...
    if(sArray.size()==1){
        ...
        individualSearch += sArray.get(sArray.size()-1);
         ...
         try
         {
             ...
             String sql = "SELECT COUNT(*) FROM prfobmaster where status_type='Completed'";
...
//                 String sql1 = "SELECT * FROM " + table;
                 String sql1 = "SELECT * FROM prfobmaster where status_type='Completed'";
               ...
               String globeSearch = " where(work_type like '%" + searchTerm + "%'" +" or prfob_ref_no like '%" + searchTerm + "%'" +" or crm_ref_no like '%" + searchTerm + "%')" + "" ;
...
//            ja.put(diffDays);
        ...
        String sql2 = "SELECT COUNT(*) FROM prfobmaster where status_type='Pending'";
        if (searchTerm != "")
        {
            sql2 = sql2 + searchSQL;
