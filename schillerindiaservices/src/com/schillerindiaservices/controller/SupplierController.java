...
public class SupplierController extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        SupplierDao demo=new SupplierDao();
        if(action!=null)
        {
            if(action.equalsIgnoreCase("edit"))
            {   
                Suppliermaster s=  SupplierDao.getById(id);
                request.setAttribute("editablerecord", s);
                RequestDispatcher rd=request.getRequestDispatcher("SupplierForm.jsp");
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
            ...
            String division=request.getParameter("product");
            
            int id=Integer.parseInt(request.getParameter("id"));

            sm.setSupplierName(name);
