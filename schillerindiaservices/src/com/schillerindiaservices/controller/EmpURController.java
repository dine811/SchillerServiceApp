...
//         String individualSearch = "";
         ...
         try
         {
             ...
             String sql = "SELECT count(*) FROM service_master s WHERE ship_dt_frm_ser_cntr IS NOT NULL  AND (repaired_brd_stk_date IS NULL ) AND s.division='"+divName+"'";
             ...
             try
             {
                 ...
                 String searchSQL = "";
                 String sql1 = "SELECT * FROM service_master s WHERE ship_dt_frm_ser_cntr IS NOT NULL  AND (repaired_brd_stk_date IS NULL ) AND s.division='"+divName+"'";
...
//            ja.put(product_model);
        ...
        String sql2 = "SELECT count(*) FROM service_master s WHERE ship_dt_frm_ser_cntr IS NOT NULL  AND (repaired_brd_stk_date IS NULL ) AND s.division='"+divName+"'";;
