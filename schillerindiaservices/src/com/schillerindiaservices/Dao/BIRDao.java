...
public class BIRDao {
    ...
    public static Birmaster getById(int id) throws ClassNotFoundException, SQLException {
        ...
        while(rs.next())
        {
          ...
          m.setTsTeamRemark(rs.getString("ts_team_verification_date"));
          m.setPsTeamRemark(rs.getString("ps_team_verification_date"));
          ...
          m.setCnrReleseDate(rs.getString("cnr_relese_date"));
          ...
          m.setApprovedDate(rs.getString("approved_date"));
          m.setCnrTecRefNum(rs.getString("cnr_tec_ref_num"));
          m.setUnitInDate(rs.getString("unit_in_date"));
    ...
    public int Insert(Birmaster bim) throws ClassNotFoundException, SQLException
    {
        ...
        PreparedStatement ps=con.prepareStatement("INSERT INTO birmaster(division,entry_date,fqc_in_date,model,"
                ...
                + "fqc_remarks,cnr_ref_no,ts_team_verification_date,\n" +
                "ps_team_verification_date,final_status,closed_date,acces_chng_remark,hrdwr_chang_remark,sftwr_chng_remark,"
        ...
        ps.setString(2,bim.getEntryDate());
     ...
     public static String getDivision(String lid) throws ClassNotFoundException, SQLException
    {
     ...
     public void update(Birmaster bim) throws ClassNotFoundException, SQLException
     {
         ...
         ps=con.prepareStatement("UPDATE birmaster SET fqc_in_date='"+bim.getFqcInDate()+"',configuration='"+bim.getConfiguration()+"',received_qty='"+bim.getReceivedQty()+"',unit_serial_no='"+bim.getUnitSerialNo()+"',invoice_no='"+bim.getInvoiceNo()+"',invoice_date='"+bim.getInvoiceDate()+"',\n" +
                                 ...
                                 + ",supplier='"+bim.getSupplier()+"',sc_engg='"+bim.getScEngg()+"',ps_engg='"+bim.getPsEngg()+"',approved_date='"+bim.getApprovedDate()+"',cnr_tec_ref_num='"+bim.getCnrTecRefNum()+"',unit_in_date='"+bim.getUnitInDate()+"',tech_remarks='"+bim.getTechRemarks()+"' WHERE id='"+bim.getId()+"'");
