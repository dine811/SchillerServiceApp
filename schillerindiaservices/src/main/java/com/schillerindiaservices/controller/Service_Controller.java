...
public class Service_Controller extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet Service_Controller</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet Service_Controller at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
...
try
     {
         ...
         try
         {
             ...
             System.out.println("div na,me1"+divName);
            ...
            {
                 {
             String sql = "SELECT count(*) FROM service_master WHERE division='"+divName+"'";
...
//                 String sql1 = "SELECT * FROM " + table;
                 String sql1;
                     ...
                     if("admin".equalsIgnoreCase(role))
                        ...
                        {
                            sql1 = "SELECT * FROM service_master WHERE division='"+divName+"'";
                        }
        ...
        while (rs1.next())
        {
            ...
            System.out.println(rs1.getString("status")+" the new statusss  issss");
...
//                            Ends
        ...
        while (rs1.next())
        {
            ...
            JSONArray ja = new JSONArray();
            ja.put(rs1.getString("ser_id"));
            System.out.println(rs1.getString("status")+" the 2nd new statusss issss");
            ja.put(rs1.getString("status"));
            ja.put(rs1.getString("entry_date"));
            ja.put(rs1.getString("sc_ref_no"));
            sc_engnr=EmployeeDao.geteName(rs1.getString("sc_engnr"));
...
//  ***          for PFRN Days Calculation
                   String ship_dt_frm_sc=rs1.getString("ship_dt_frm_ser_cntr");
                   System.out.println("1st date -- "+ship_dt_frm_sc);
                    if(ship_dt_frm_sc == null )
                    {
                      String ship_date_from_serCenter = rs1.getString("ser_centre_received_date");
                      System.out.println("1st date -- ship_date_from_serCenter   "+ship_date_from_serCenter);
                      String startDatePFRN = ship_date_from_serCenter;
                         DateFormat df1 = new SimpleDateFormat("yyyy-MM-dd"); 
            ...
            ja.put(PFRNdiffDays);  
                ...
                //        SimpleDateFormat simp=new SimpleDateFormat("MM/dd/yyyy HH:mm:ss");
                        ...
                        long diffrnce=d22.getTime()-d21.getTime();
                        long difDays=diffrnce/(24 * 60 * 60 * 1000);
                        System.out.println("difff dayss  "+difDays);
                        ja.put(difDays+" SC");}
                        catch(Exception e)
                        {
                            e.printStackTrace();
...
//      ***                    pending days for OBPending
            ...
            ja.put(PFRNdiffDays);  
                 ...
                 //       SimpleDateFormat simp=new SimpleDateFormat("MM/dd/yyyy HH:mm:ss");
                        ...
                        long diffrnce=d22.getTime()-d21.getTime();
                        long difDays=diffrnce/(24 * 60 * 60 * 1000);
                        System.out.println( "diffdaysss  "+difDays+" OB");
                        ja.put(difDays+" OB");}
                        catch(Exception e)
                        {
                            e.printStackTrace();
...
//     ***                   pending Days UnderRepair
                            String recived_date=rs1.getString("repaired_brd_stk_date");
                          //  Date received_date1 = rs1.getDate("repaired_brd_stk_date");
                            System.out.println("recived_date   ---"+recived_date);
                            ...
                            if(recived_date == null)
                    {
                            	System.out.println("inside recived_date if");
                      String ship_date_from_serCenter = rs1.getString("ser_centre_received_date");
                      System.out.println("ship_date_from_serCenter  --- "+ship_date_from_serCenter);
                      String startDatePFRN = ship_date_from_serCenter;
                         DateFormat df1 = new SimpleDateFormat("yyyy-MM-dd"); 
               ...
               //     SimpleDateFormat PFRNformat = new SimpleDateFormat("MM/dd/yyyy HH:mm:ss");
                        ...
                        java.util.Date d21 = null;
                             ...
                             long PFRNdiff = d21.getTime() - d11.getTime();
                             long PFRNdiffDays = PFRNdiff / (24 * 60 * 60 * 1000);
                             System.out.println("PFRNdiffDays  --- "+PFRNdiffDays);
            ja.put(PFRNdiffDays);  
                    }
                    else
                    {
                    	System.out.println("inside rec date else");
                        try{
                        String date1=rs1.getString("ser_centre_received_date");
                        DateFormat df11=new SimpleDateFormat("yyyy-MM-dd");
...
//                            Ends
           ...
           ja.put("");
            ...
            array.put(ja);
            System.out.println("before array prnt");
            System.out.println(" this is array---"+ja.length());
            System.out.println(" this is array 222 ---"+ja.toString());
        }
                        }
...
//        processRequest(request, response);
              ...
              ServiceDao.Excel(request, response);
    }
