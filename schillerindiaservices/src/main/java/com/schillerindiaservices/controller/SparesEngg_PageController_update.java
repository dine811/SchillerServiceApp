 ...
 * @author ShineLoGics
 */
@WebServlet("/SparesEngg_PageController_update")
public class SparesEngg_PageController_update extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try
     {
         ...
         String table = "SparesRequestList";
    ...
    if(sArray.size()==1){
        ...
        individualSearch += sArray.get(sArray.size()-1);
         ...
         try
         {
             ...
             String sql = "SELECT COUNT(*) FROM sparemaster WHERE  final_status='Pending'";
...
//                 String sql1 = "SELECT * FROM " + table;
                 String sql1 = "SELECT * FROM sparemaster WHERE   final_status='Pending'";
...
//            ja.put(diffDays);
        ...
        String sql2 = "SELECT COUNT(*) FROM sparemaster WHERE  final_status='Pending'";
        if (searchTerm != "")
        {
            sql2 = sql2 + searchSQL;
