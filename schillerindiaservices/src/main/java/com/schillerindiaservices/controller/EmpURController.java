...
import com.schillerindiaservices.Dao.EmpURDao;
 ...
 * @author ShineLoGics
 */
public class EmpURController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet EmpURController</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet EmpURController at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
...
//         out.println("sStart" + sStart);
//         out.println("sAmount" + sAmount);
//         out.println("sStart" + sStart);
...
//         String individualSearch = "";
         ...
         try
         {
             ...
             String sql = "SELECT count(*) FROM service_master s WHERE ship_dt_frm_ser_cntr IS NOT NULL AND ship_dt_frm_ser_cntr IS NOT NULL AND repaired_brd_stk_date IS NULL AND s.division='"+divName+"'";
             ...
             try
             {
                 ...
                 String searchSQL = "";
                 String sql1 = "SELECT * FROM service_master s WHERE ship_dt_frm_ser_cntr IS NOT NULL AND ship_dt_frm_ser_cntr IS NOT NULL  AND repaired_brd_stk_date IS NULL AND s.division='"+divName+"'";
...
//            ja.put(product_model);
        ...
        String sql2 = "SELECT count(*) FROM service_master s WHERE ship_dt_frm_ser_cntr IS NOT NULL AND ship_dt_frm_ser_cntr IS NOT NULL AND repaired_brd_stk_date IS NULL AND s.division='"+divName+"'";;
        ...
        //             localThrowable3.addSuppressed(localThrowable2);
            ...
            Logger.getLogger(EmpURController.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
            throws ServletException, IOException {
        EmpURDao.UnderRepairExcel(request, response);
    }
