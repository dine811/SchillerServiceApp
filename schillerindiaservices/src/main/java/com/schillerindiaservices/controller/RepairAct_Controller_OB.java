...
public class RepairAct_Controller_OB extends HttpServlet {
        ...
        individualSearch += sArray.get(sArray.size()-1);
         ...
         try
         {
            ...
            //   String divName=PendingActivityDao.PendingActDivName(nam);
             ...
             String sql = "SELECT COUNT(*) FROM repair_master WHERE category='OB' AND   status='pending'";
...
//                 String sql1 = "SELECT * FROM " + table;
                 String sql1 = "SELECT * FROM repair_master WHERE category='OB' AND status='pending'";
...
//            ja.put(diffDays);
        ...
        String sql2 = "SELECT COUNT(*) FROM repair_master WHERE category='OB' AND status='pending'";
        if (searchTerm != "")
        {
            sql2 = sql2 + searchSQL;
