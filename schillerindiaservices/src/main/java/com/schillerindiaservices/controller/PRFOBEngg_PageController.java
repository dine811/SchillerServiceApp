 ...
 * @author ShineLoGics
 */
public class PRFOBEngg_PageController extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
    	...
    	System.out.println("prff ob controllerrrrr");
       try
     {
    ...
    if(sArray.size()==1){
        ...
        individualSearch += sArray.get(sArray.size()-1);
         ...
         {  
             ...
             String sql = "SELECT COUNT(*) FROM prfobmaster WHERE division='"+divName+"' AND status_type='pending'";
...
//                 String sql1 = "SELECT * FROM " + table;
                 String sql1 = "SELECT * FROM prfobmaster WHERE division='"+divName+"'  AND status_type='pending'";
...
//            ja.put(diffDays);
        ...
        String sql2 = "SELECT COUNT(*) FROM prfobmaster WHERE division='"+divName+"' AND status_type='pending' ";
        if (searchTerm != "")
        {
            sql2 = sql2 + searchSQL;
