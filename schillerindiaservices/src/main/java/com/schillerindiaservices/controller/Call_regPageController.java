 ...
 * @author ShineLoGics
 */
public class Call_regPageController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet Call_regPageController</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet Call_regPageController at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
        ...
        individualSearch += sArray.get(sArray.size()-1);
         ...
         try
         {
             ...
             int nam=0;
               ...
               System.out.println("loguseridd  "+session.getAttribute("loguserid"));
             ...
             String sql = "SELECT COUNT(*) FROM callregister_demo WHERE division='"+divName+"' AND status_type='Pending'";
...
//                 String sql1 = "SELECT * FROM " + table;
                 String sql1 = "SELECT * FROM callregister_demo WHERE division='"+divName+"' AND status_type='Pending'";
               ...
               String globeSearch = " and (engineer like '%" + searchTerm + "%'" +" or status_type like '%" + searchTerm + "%'" +" or entry_date like '%" + searchTerm + "%')" + "" ;
        ...
        while (rs1.next())
        {
           ...
           ja.put(rs1.getString("division"));
            ja.put(utilfn.getDateFormat(rs1.getString("entry_date")));
            ja.put(utilfn.getDateFormat(rs1.getString("call_date")));
...
//            ja.put(diffDays);
        ...
        String sql2 = "SELECT COUNT(*) FROM callregister_demo WHERE division='"+divName+"' AND status_type='Pending'";
        if (searchTerm != "")
        {
            sql2 = sql2 + searchSQL;
