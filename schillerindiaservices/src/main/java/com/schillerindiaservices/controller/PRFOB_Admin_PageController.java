 ...
 * @author ShineLoGics
 */
public class PRFOB_Admin_PageController extends HttpServlet {
    ...
    if(sArray.size()==1){
        ...
        individualSearch += sArray.get(sArray.size()-1);
         ...
         try
         {
             ...
             String sql = "SELECT COUNT(*) FROM prfobmaster where status_type='Pending'";
...
//                 String sql1 = "SELECT * FROM " + table;
                 String sql1 = "SELECT * FROM prfobmaster where status_type='Pending'";
