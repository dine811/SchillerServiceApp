 ...
 * @author ShineLoGics
 */
public class PendingAct_adminPAGEController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet PendingAct_adminPAGEController</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet PendingAct_adminPAGEController at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    if(sArray.size()==1){
        ...
        individualSearch += sArray.get(sArray.size()-1);
         ...
         try
         {
             ...
             String sql = "SELECT COUNT(*) FROM pendingactmaster WHERE status_type='pending'";
             ...
             try
             {
                 ...
                 String searchSQL = "";
                 String sql1 = "SELECT * FROM " + table+" WHERE status_type='pending'";
//                 String sql1 = "SELECT * FROM pendingactmaster WHERE division='"+divName+"'";
...
//            ja.put(diffDays);
        ...
        String sql2 = "SELECT COUNT(*) FROM " + table+" WHERE status_type='pending'";
//        String sql2 = "SELECT COUNT(*) FROM pendingactmaster WHERE division='"+divName+"'";
        if (searchTerm != "")
        {
            sql2 = sql2 + searchSQL;
