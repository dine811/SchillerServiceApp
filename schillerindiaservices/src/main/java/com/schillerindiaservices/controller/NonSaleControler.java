       ...
       if(id==0)
       {
           try {
			...
			sc_in_date =  utilfn.getRev_DateFormat(sc_in_date);
			   ...
			   replace_ship_date= utilfn.getRev_DateFormat(replace_ship_date);
			   defect_unit_recv_date = utilfn.getRev_DateFormat(defect_unit_recv_date);
               ...
               if(cust_name!=null)
               {
                        ...
                        nsm.setDefectUnitRecivedDate(defect_unit_recv_date);
               }else{
                        nsm.setCustName("NIL");
                        nsm.setReplacedUnitSN("NIL");
                        nsm.setReplaceShipDate(null);
                        nsm.setDefectUnitRecivedDate(null);
               }
