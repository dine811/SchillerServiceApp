 ...
 * @author ShineLoGics
 */
public class PendingAct_PaginController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet PendingAct_PaginController</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet PendingAct_PaginController at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try
     {
        	System.out.println("insideee get method");
    ...
    if(sArray.size()==1){
        ...
        individualSearch += sArray.get(sArray.size()-1);
         ...
         try
         {
             ...
             String sql = "SELECT COUNT(*) FROM pendingact_master WHERE division='"+divName+"' AND status_type='Pending'";
...
//                 String sql1 = "SELECT * FROM " + table;
                 String sql1 = "SELECT * FROM pendingact_master WHERE division='"+divName+"' AND status_type='Pending'";
        ...
        System.out.println("guhjghjkg  "+rs1.first());
        while (rs1.next())
        {
         ...
         //  System.out.println("entry date --->"+utilfn.getDateFormat(rs1.getDate("entry_date").toString()));
            System.out.println("entry date "+rs1.getString("entry_date"));
           ja.put(rs1.getString("entry_date"));
...
//            ja.put(diffDays);
        ...
        String sql2 = "SELECT COUNT(*) FROM pendingact_master WHERE division='"+divName+"' AND status_type='Pending'";
        if (searchTerm != "")
        {
            sql2 = sql2 + searchSQL;
