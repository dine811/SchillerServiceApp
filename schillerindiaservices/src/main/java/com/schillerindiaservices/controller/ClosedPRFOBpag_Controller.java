 ...
 * @author ShineLoGics
 */
public class ClosedPRFOBpag_Controller extends HttpServlet {
    ...
    if(sArray.size()==1){
        ...
        individualSearch += sArray.get(sArray.size()-1);
         ...
         {  
             ...
             String sql = "SELECT COUNT(*) FROM prfobmaster WHERE division='"+divName+"'";
...
//                 String sql1 = "SELECT * FROM " + table;
                 String sql1 = "SELECT * FROM prfobmaster WHERE division='"+divName+"'";
...
//            ja.put(diffDays);
        ...
        String sql2 = "SELECT COUNT(*) FROM prfobmaster WHERE division='"+divName+"'";
        if (searchTerm != "")
        {
            sql2 = sql2 + searchSQL;
