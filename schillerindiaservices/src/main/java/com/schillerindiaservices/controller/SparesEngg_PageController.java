 ...
 * @author ShineLoGics
 */
@WebServlet("/SparesEngg_PageController")
public class SparesEngg_PageController extends HttpServlet {
       ...
       if(sArray.size()==1){
           ...
           individualSearch += sArray.get(sArray.size()-1);
            ...
            try
            {
                ...
                String sql = "SELECT COUNT(*) FROM sparemaster WHERE division='"+divName+"' AND final_status='Pending'";
...
//                    String sql1 = "SELECT * FROM " + table;
                    String sql1 = "SELECT * FROM sparemaster WHERE division='"+divName+"' AND final_status='Pending'";
...
//               ja.put(diffDays);
           ...
           String sql2 = "SELECT COUNT(*) FROM sparemaster WHERE division='"+divName+"' AND final_status='Pending'";
           if (searchTerm != "")
           {
               sql2 = sql2 + searchSQL;
