...
public class Mailjob8 implements Job{
	...
	public void execute(JobExecutionContext arg0) throws JobExecutionException {
		...
		String fdate1=formattedString2.concat(" 10:00:00");
		//System.out.println(fdate1+"fdate 1 issss");
		String ldate1=formattedString.concat(" 09:59:59");
		//System.out.println(ldate1+"ldate 2 issss");
		
		String report_type="ob_pending";
		
		
		
		
	 try { 
		   Autoesclation_OBpending_dao.OBPendingExcel(fdate1, ldate1, report_type);
		 //   Autoesclation_OBpending_dao.OBPendingExcel_Local(fdate1, ldate1, report_type);
