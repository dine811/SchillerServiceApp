...
public class Mailjob4 implements Job{

	@Override
	public void execute(JobExecutionContext arg0) throws JobExecutionException {
		// TODO Auto-generated method stub
		Date dt=new Date();
		System.out.println("its workinggg 4444"+ dt);
	...
	LocalDate yeserday2=today.withDayOfMonth(15);
		//LocalDate yeserday3=yeserday2.withDayOfMonth(15);
		//LocalDate yeserday4=yeserday.withDayOfMonth(yeserday3.lengthOfMonth());
		...
		String fdate1=formattedString.concat(" 21:00:00");
	...
	//	 AutomaticmailScarplistDao.scarpList_mailExport_Local(fdate1, ldate1, report_type);
