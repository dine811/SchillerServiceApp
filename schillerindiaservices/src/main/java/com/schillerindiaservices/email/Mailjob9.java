...
public class Mailjob9 implements Job{
	...
	public void execute(JobExecutionContext arg0) throws JobExecutionException {
		...
		String fdate1=formattedString2.concat(" 11:30:00");
		//System.out.println(fdate1+"fdate 1 issss");
		String ldate1=formattedString.concat(" 11:29:59");
		//System.out.println(ldate1+"ldate 2 issss");
		
		String report_type="under_repair";
		
		
		
		
	 try {
		  EscalutionUnderRepairDao.UnderRepairEscalationExcel(fdate1, ldate1, report_type);
		  //  EscalutionUnderRepairDao.UnderRepairEscalationExcel_Local(fdate1, ldate1, report_type);
