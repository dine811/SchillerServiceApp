...
import com.schillerindiaservices.Dao.AutomaticmailStock_list_Dao;

public class Mailjob_stocklist implements Job{
	...
	public void execute(JobExecutionContext arg0) throws JobExecutionException {
		...
		String fdate1=formattedString2.concat(" 20:00:00");
		//System.out.println(fdate1+"fdate 1 issss");
		String ldate1=formattedString.concat(" 19:59:59");
		//System.out.println(ldate1+"ldate 2 issss");
		
		String report_type="stocklist";
		//String report_type="scraplist";
		
		
		
	 try {
		AutomaticmailStock_list_Dao.stockList_mailExport(fdate1, ldate1, report_type);
		// AutomaticmailStock_list_Dao.stockList_mailExport_Local(fdate1, ldate1, report_type);
