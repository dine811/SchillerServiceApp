...
public class Mailjob6_nonsale implements Job{
	...
	public void execute(JobExecutionContext arg0) throws JobExecutionException {
		...
		String fdate1=formattedString2.concat(" 19:00:00");
		//System.out.println(fdate1+"fdate 1 issss");
		String ldate1=formattedString.concat(" 18:59:59");
		//System.out.println(ldate1+"ldate 2 issss");
		//String fdate1=formattedString2;
		//String ldate1= formattedString;
		
		
		String report_type="nonsalepending";
		
		
		
		
	 try {
		//ExportNonSaleDao2_Auotesclation.NonSaleAdmin_list(fdate1, ldate1, report_type);
			ExportNonSaleDao2_Auotesclation.NonSaleAdmin_list_Local(fdate1, ldate1, report_type);
