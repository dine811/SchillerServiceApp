...
public class Mailjob10 implements Job{
	...
	public void execute(JobExecutionContext arg0) throws JobExecutionException {
		...
		String fdate1=formattedString2.concat(" 09:00:00");
		//System.out.println(fdate1+"fdate 1 issss");
		String ldate1=formattedString.concat(" 08:59:59");
		//System.out.println(ldate1+"ldate 2 issss");
		
		String report_type="bir_pending";
		
		
		
		
	 try {
	 Export_BIRDAO_Auto_Esclation.BIRAdmin_AutoEsclation(fdate1, ldate1, report_type);
	//	 Export_BIRDAO_Auto_Esclation.BIRAdmin_AutoEsclation_Local(fdate1, ldate1, report_type);
