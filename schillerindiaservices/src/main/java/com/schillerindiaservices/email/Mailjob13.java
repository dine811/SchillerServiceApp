...
import com.schillerindiaservices.Dao.Automaticmail_jobsheet_pending;
...
public class Mailjob13 implements Job{

	@Override
	public void execute(JobExecutionContext arg0) throws JobExecutionException {
		// TODO Auto-generated method stub
		
		//coding for jobsheet pending auto esclation
		...
		String report_type="jobsheet_pending";
		String status="Pending";
		
		
		
	 try {
		 Automaticmail_jobsheet_pending.jobsheet_pending_Automail(fdate1, ldate1, report_type);;
				// Automaticmail_jobsheet_pending.jobsheet_pending_Automail_Local(fdate1, ldate1, report_type);
