...
public class Mailjob12 implements Job{

	@Override
	public void execute(JobExecutionContext arg0) throws JobExecutionException {
		// TODO Auto-generated method stub
		
		//coding for PRFOB COMPLETED auto esclation
		...
		String fdate1=formattedString2.concat(" 18:30:00");
		//System.out.println(fdate1+"fdate 1 issss");
		String ldate1=formattedString.concat(" 18:29:59");
		//System.out.println(ldate1+"ldate 2 issss");
		
		String report_type="prf/ob_completed";
		String status="Completed";
		
		
		
	 try {
		 Export_PRFOB_Auto_Esclation2.PRFOB_AutoEsclation(fdate1, ldate1, report_type, status);
		// Export_PRFOB_Auto_Esclation2.PRFOB_AutoEsclation_Local(formattedString2, formattedString, report_type, status);
