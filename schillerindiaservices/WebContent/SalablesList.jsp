<%-- 
    Document   : nonSaleAdminList
    Created on : Oct 10, 2017, 9:56:22 AM
    Author     : ShineLoGics
--%>
...
<%
  ...
  %>
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h3 class="page-header">Non Saleable List</h3>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <div class="col-lg-10">
                <input type="hidden" id="role" value="<%=role%>">
                     <form role="form" action="ExportNonSale_AdminController" method="post">
                       ...
                       <div class="form-group col-md-3" style="padding-right: 50px;">
                           ...
                           <div class="form-group col-md-3" style="padding-right: 50px;">
                            ...
                            <%
                                if(role.equalsIgnoreCase("admin")||role.equalsIgnoreCase("ViceChancellor")||role.equalsIgnoreCase("fqc"))
                                {
                                %>
                           <div class="form-group col-md-4" style="padding-right: 50px;">
                            ...
                            <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
                                <thead>
                                    <tr>
                                            ...
                                            <th>Entry Date</th>
                                            <th>Unit Details</th>
                                            <th>FQC Inward Date</th>
                                            <th>Model</th>
                                            <th>FQC Remarks</th>
                                            <th>SC Inward Date</th>
                                            <th>SC Observation</th>
                                            <th>Model SN</th>
                                            <th>Tentative Date</th>
                                            <th>Ship Date to FQC</th>
                                            <th>Final Status</th>
                                            <th>Action</th>
...
<!--    <script>
    ...
    var table= $('#dataTables-example').DataTable( {
        "processing": true, 
        "serverSide": true,
        "ajax":  "SalablesPage_Controller",
        "fnRowCallback": function( nRow, aData, iDisplayIndex ) {  
//                $('td:eq(1)', nRow).html(aData[1]);  
                var qid=document.getElementById("qid").value;
//                 $('td:eq(10)', nRow).html('<a href="CallRegUpdate.jsp">Update</a>'); 
                $(role=='FQC'||role=='Engineer'?
                $('td:eq(11)', nRow).html('<a href="NonSaleControler?action=edit&id='+aData[0]+'">Update</a> '):
                     $('td:eq(11)', nRow).html('<a href="NonSaleControler?action=edit&id='+aData[0]+'">Update</a> | <a href="NonSaleControler?action=delete&id='+aData[0]+'&pg=sl">Delete</a>')   
                )
                return nRow;  
            },  
} );
