        ...
        <div id="page-wrapper">
             <div class="row">
                <div class="col-lg-12">
                    ...
                    <div align="left">
                            <div class="col-lg-10" >
                                <form role="form" action="ServiceControllerEngg" method="post">
                                <div class="form-group col-md-3" style="padding-right: 50px;">
                                <label class="col-sm-10 " for="form-field-1"> From Date </label>
                    ...
                    <div align="Left">
                         <a href="ServiceForm.jsp"><button type="button" class="btn btn-primary">Add New Record</button></a> 
                    </div>
