        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div align="left">
                            <div class="col-lg-1" >
                        <form role="form" action="ExportUnderRepairController" method="post">
                     ...
                     <div align="">
                        ...
                        <form role="form" action="EscalutionUnderRepairController" method="post">
...
<!--                <div class="col-lg-12">
    ...
    var table= $('#dataTables-example').DataTable( {
        "processing": true,
        "serverSide": true,
        "ajax":  "Under_RepairController",
        "fnRowCallback": function( nRow, aData, iDisplayIndex ) {  
                $('td:eq(1)', nRow).html(aData[1]);  
//                $('td:eq(12)', nRow).html('<a href="UnderRepairController?action=delete&id='+aData[0]+'">Delete</a>');  
//                $('td:eq(12)', nRow).html('<a href="UnderRepairController?action=edit&id='+aData[0]+'">Edit</a>');  
                return nRow;  
            },  
} );
