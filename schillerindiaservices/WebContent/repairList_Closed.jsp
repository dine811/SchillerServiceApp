            ...
            <div class="row">
                <div class="col-lg-10">
                     ...
                     <form role="form" action="RepairExport_Controller" method="post">
                                      ...
                                      <input  type="hidden" name="cat" value="ALL_Closed"/>
...
<!--    <script>
    ...
    var table= $('#dataTables-example').DataTable( {
        "processing": true, 
        "serverSide": true,
        "ajax":  "RepairActClosed_Controller",
        "fnRowCallback": function( nRow, aData, iDisplayIndex ) {  
//                $('td:eq(1)', nRow).html(aData[1]);  
                var qid=document.getElementById("qid").value;
//                 $('td:eq(10)', nRow).html('<a href="CallRegUpdate.jsp">Update</a>'); 
            //    $('td:eq(10)', nRow).html('<a href="Repair_UpdateController?action=edit&id='+aData[0]+'">Update</a>');  
                return nRow;  
            },  
} );
