                                    ...
                                    <input type="hidden" name="id" class="form-control" value="<%=id%>">
                                        ...
                                        <div class="col-lg-4">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="tar_closed_date" id="datepicker-2" value="" class="form-control" required="" >
                                        </div>
                                        ...
                                        <div class="col-lg-4">
                                            ...
                                            if(role.equalsIgnoreCase("ProductSupport")||role.equalsIgnoreCase("fqc")){
                                            	%>
                                            	<div class="form-group">
