...
<%
        ...
        <div id="page-wrapper">
            ...
            <div class="col-lg-10">
                     ...
                     <form role="form" action="ExportClosedCalls_Controller" method="post">  
                         <%
                      ...
                      <div class="form-group col-md-3" style="padding-right: 50px;">
                                <label class="col-sm-9 " for="form-field-1"> Division </label>
                                 <div class="col-sm-12">
                                         <input type="hidden" value="cc" name="mine">
                                         <select class="form-control" name="division" id="divi" onchange="requ()" required="">
                                         <option value="">Select Division</option>
                                         <option value="1" style="font-weight: bold;">All Division</option>
                                         <%
                                            ...
                                            <%
                                                ...
                                                %>
                                                <input type="hidden" value="ccc" name="mine">
                                                <%
                                                    }
                                                    %>
                            <div class="form-group col-md-3" style="padding-right: 50px;">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        ...
                        <input type="hidden" id="qid" name="qid" value="<%=role%>">
                        <!-- /.panel-heading -->
...
<!--    <script>
    ...
    var table= $('#dataTables-example').DataTable( {
        "processing": true, 
        "serverSide": true,
        "ajax":  "ClosedCalls_Controller",
        "fnRowCallback": function( nRow, aData, iDisplayIndex ) {  
//                $('td:eq(2)', nRow).html(aData[1]);  
                var qid=document.getElementById("qid").value;
                $(qid=='Admin'||qid=='ViceChancellor'?
                $('td:eq(9)', nRow).html('<a href="CallRegisterController?action=edit&id='+aData[0]+'&pg=clsd">Update</a> | <a href="CallRegisterController?action=delete&id='+aData[0]+'&pg=clsd">Delete</a>')  :''); 
                return nRow;
