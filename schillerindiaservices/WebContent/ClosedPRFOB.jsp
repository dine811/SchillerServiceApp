            ...
            <ul class="nav navbar-top-links navbar-right">
                ...
                <li class="dropdown">
                    <a class="dropdown-toggle" data-toggle="dropdown" href="#">
                        ASHOK KUMAR<i class="fa fa-user fa-fw"></i> <i class="fa fa-caret-down"></i>
                    </a>
...
<!--                        <li>
                        ...
                        <li>
                         ...
                         <li>
                             <a href="ScarpListEngg.jsp">Scarp List </a>
                        </li>   
                        <li>
                        ...
                        <li>
                            <a href="ClosedPRFOB.jsp">Closed PRF/OB</a>
                        </li>
                        <li>
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h3 class="page-header">Closed PRF/OB List</h3>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <div class="col-lg-12">
                <input type="hidden" id="role" value="Engineer">
                     <form role="form" action="ExportPRFOB_AdminController" method="post">
                           ...
                           <div class="form-group col-md-3" style="padding-right: 50px;">
                                <label class="col-sm-8 " for="form-field-1">To Date</label>
                                   ...
                                   <input type="hidden" name="division" value="02">
...
<!--    <script>
    ...
    var table= $('#dataTables-example').DataTable( {
        "processing": true, 
        "serverSide": true,
        "ajax":  "ClosedPRFOBpag_Controller",
        "fnRowCallback": function( nRow, aData, iDisplayIndex ) {  
//                $('td:eq(1)', nRow).html(aData[1]);  
                var qid=document.getElementById("qid").value;
                $(role=='ServiceCoordinator'||role=='Engineer'?
                $('td:eq(13)', nRow).html('<a href="PRFOBController?action=edit&id='+aData[0]+'">Update</a>') :
                $('td:eq(13)', nRow).html('<a href="PRFOBController?action=edit&id='+aData[0]+'">Update</a> | <a href="PRFOBController?action=delete&id='+aData[0]+'">Delete</a>')  
                )
                return nRow;  
            },  
} );
