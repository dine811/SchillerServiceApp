                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="col-sm-6">
                                <div class="col-sm-2">
                            <form action="EmpOBPendingController" method="post">
                                <input type="submit" value="Export" class="btn btn-primary">
                             </form>
                                </div>
<!--                                <div class="col-sm-2">
                                    <form action="Emp_ScrapOBPController" method="post">
...
<!--    <script>
    ...
    var table= $('#dataTables-example').DataTable( {
        "processing": true, 
        "serverSide": true,
        "ajax":  "EmpOBPendingController",
        "fnRowCallback": function( nRow, aData, iDisplayIndex ) {  
                $('td:eq(1)', nRow).html(aData[1]);  
                var qid=document.getElementById("qid").value;
                $('td:eq(14)', nRow).html('<a href="OBPendingController?action=edit&id='+aData[0]+'&qid='+qid+'">Update</a>');  
                
                if(aData[15] == 'NR'){
                    $('td:eq(15)', nRow).html(' <a href="RepairUpdateController?action=edit&cat=OB&id='+aData[0]+'">SR</a>');
                //    $('td:eq(16)', nRow).html('<p>RP</p>');
                }else if(aData[15] == 'RP'){
                    $('td:eq(15)', nRow).html('<p>RP</p>');

                	
                }else if(aData[15] == 'RC'){
                    $('td:eq(15)', nRow).html('<p>RC</p>');
