...
else
{
  ...
  %>
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h3 class="page-header">Repair Activity List - PFRN</h3>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
            <div class="row">
                <div class="col-lg-10">
                     ...
                     <form role="form" action="RepairExport_Controller" method="post">
                                        <input  type="hidden" name="id"/>  
                                        <input  type="hidden" name="status" value="pending"/>  
                                         <input  type="hidden" name="cat" value="PFRN"/>
                     <div class="form-group col-md-3" style="padding-right: 50px;">
                           ...
                           <div class="form-group col-md-3" style="padding-right: 50px;">
                                ...
                                <a href="PendingActivityEnggForm.jsp"></a>
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            ...
                            <form role="form" style="margin-top: px;" >
                            <div align="Left">
...
<!--    <script>
    ...
    var table= $('#dataTables-example').DataTable( {
        "processing": true, 
        "serverSide": true,
        "ajax":  "RepairAct_Controller",
        "fnRowCallback": function( nRow, aData, iDisplayIndex ) {  
//                $('td:eq(1)', nRow).html(aData[1]);  
                var qid=document.getElementById("qid").value;
//                 $('td:eq(10)', nRow).html('<a href="CallRegUpdate.jsp">Update</a>'); 
                $('td:eq(9)', nRow).html('<a href="Repair_UpdateController?action=edit&cat=PFRN&id='+aData[0]+'">Update</a>');  
                return nRow;  
            },  
} );
