<%-- 
    Document   : PendingActListAdmin
    Created on : Oct 4, 2017, 5:25:11 PM
    Author     : ShineLoGics
--%>
...
else
{
  ...
  %>
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h3 class="page-header">Pending Activity List</h3>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
            <div class="col-lg-10">
                     ...
                     <form role="form" action="ExportPENDACT_AdminController_Completed" method="post">
...
<!--    <script>
    ...
    var table= $('#dataTables-example').DataTable( {
        "processing": true, 
        "serverSide": true,
        "ajax":  "ExportPENDACT_AdminController_Completed",
        "fnRowCallback": function( nRow, aData, iDisplayIndex ) {  
                $('td:eq(1)', nRow).html(aData[1]);  
                var qid=document.getElementById("qid").value;
                $(role=="Admin"||role=="ViceChancellor"?
                        $('td:eq(12)', nRow).html('<a href="PendingActivityController?action=edit&id='+aData[0]+'">Update</a>| <a href="PendingActivityController?action=delete&id='+aData[0]+'">Delete</a>'):
                                $('td:eq(12)', nRow).html('<a href="PendingActivityController?action=edit&id='+aData[0]+'">Update</a>')
                        )
