                           ...
                           <div class="form-group col-md-3" style="padding-right: 50px;">
                                <label class="col-sm-8 " for="form-field-1">To Date</label>
                                    ...
                                    <div class="col-sm-12">
                                        ...
                                        <div class="form-group col-md-3" style="padding-right: 50px;">
                                <label class="col-sm-10 " for="form-field-1"> Division </label>
                                 <div class="col-sm-12">
...
<!--    <script>
    ...
    var table= $('#dataTables-example').DataTable( {
        "processing": true, 
        "serverSide": true,
        "ajax":  "PRFOB_Admin_PageController2_closed",
        "fnRowCallback": function( nRow, aData, iDisplayIndex ) {  
                $('td:eq(1)', nRow).html(aData[1]);  
                var qid=document.getElementById("qid").value;
                $(role=='ServiceCoordinator'?
                $('td:eq(14)', nRow).html('<a href="PRFOBController?action=edit&id='+aData[0]+'">Update</a>') :
                $('td:eq(14)', nRow).html('<a href="PRFOBController?action=edit&id='+aData[0]+'">Update</a> | <a href="PRFOBController?action=delete&id='+aData[0]+'">Delete</a>')  
                )
                return nRow;  
            },  
} );
