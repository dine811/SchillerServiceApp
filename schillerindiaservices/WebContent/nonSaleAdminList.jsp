...
<!--    <script>
    ...
    var table= $('#dataTables-example').DataTable( {
        "processing": true, 
        "serverSide": true,
        "ajax":  "NonSaleAdmin_PageController",
...
//                 $('td:eq(10)', nRow).html('<a href="CallRegUpdate.jsp">Update</a>'); 
                ...
                $('td:eq(11)', nRow).html('<a href="NonSaleControler?action=edit&id='+aData[0]+'">Update</a> '):
                     $('td:eq(11)', nRow).html('<a href="NonSaleControler?action=edit&id='+aData[0]+'">Update</a> | <a href="NonSaleControler?action=delete&id='+aData[0]+'&pg=l">Delete</a>')   
                )
                return nRow;  
            },  
} );
