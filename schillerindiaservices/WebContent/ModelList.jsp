...
%>
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h3 class="page-header">Model List</h3>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
                            ...
                            <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
                                ...
                                <tbody>
                                    <%  
                                            ...
                                            List<Model> list=ModelDao.getAllRecords();
                                            if(list!=null)
                                            {
                                                Iterator itr=list.iterator();
                                                while(itr.hasNext())
                                                {
                                                    Model d1=(Model)itr.next();
                                                    id=d1.getModelId();
                                    
                                                    productid=d1.getProductId();
                                                    String prodid=String.valueOf(productid);
                                                    productname    =ProductDao.getProdName(prodid);
                                                    
                                                    modelno =String.valueOf(d1.getModelId());
                                                    ...
                                                    %>
                                                        ...
                                                        <td><%=modelname%></td>
                                                        <td><%=modeldesc%></td>
                                                        <td><a href="ModelController?id=<%=id%>&action=edit">Edit</a>|<a href="ModelController?id=<%=id%>&action=delete">Delete</a></td>
                                                    </tr>
                                        <%
                                                }
                                            }
