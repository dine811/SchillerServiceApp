                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <form role="form" action="UnderRepairController" method="POST">
                            ...
                            <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
                                ...
                                <tbody>
                                    <%  
                                            ...
                                            Date t1=null;
                                            Date t2=null;
                                           List list = (List)request.getAttribute("UnderRepair");
                                            if(list!=null)
                                            {
...
<!--    <script>
    ...
    $('#example').DataTable( {
        "processing": true,
        "serverSide": true,
        "ajax": "UnderRepairController",
        "fnRowCallback": function( nRow, aData, iDisplayIndex ) {  
                $('td:eq(8)', nRow).html('<a href="UnderRepairController?action=delete&custid='+aData[0]+'">Delete</a>');  
                $('td:eq(7)', nRow).html('<a href="UnderRepairController?action=edit&custid='+aData[0]+'">Edit</a>');  
                return nRow;  
            },  
} );
     });   
