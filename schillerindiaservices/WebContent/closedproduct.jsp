...
<%
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h3 class="page-header">SC Closed Product </h3>
                    <div align="left">
                            <div class="col-lg-1" >
                        <form role="form" action="ExportClosedController" method="post">
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <form role="form" action="Closed_Controller" method="get">
