...
%>
      ...
      System.out.println("qid---->"+ qid);
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h3 class="page-header">Under Repair</h3>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="col-sm-6">
                                <div class="col-sm-2">
                            <form action="EmpURController" method="post">
                                <input type="submit" value="Export" class="btn btn-primary">
                             </form>
                                </div>
<!--                                <div class="col-sm-2">
                                    <form action="Emp_ScapURController" method="post">
                                <input type="submit" value="Scrap List" class="btn btn-primary">
                            </form>  
                                </div>-->
                           </div>
...
<script>
    ...
    var table= $('#dataTables-example').DataTable( {
        ...
        "processing": true,
        "serverSide": true,
        "ajax":  "EmpURController",
        "fnRowCallback": function( nRow, aData, iDisplayIndex ) {  
                $('td:eq(1)', nRow).html(aData[1]); 
                 var qid=document.getElementById("qid").value;
                if(aData[16] == 'NR'){
                    $('td:eq(16)', nRow).html(' <a href="RepairUpdateController?action=edit&cat=UR&id='+aData[0]+'">SR</a>');
                //    $('td:eq(16)', nRow).html('<p>RP</p>');
                }else if(aData[16] == 'RP'){
                    $('td:eq(16)', nRow).html('<p>RP</p>');

                	
                }else if(aData[16] == 'RC'){
                    $('td:eq(16)', nRow).html('<p>RC</p>');

                	
                }else{
                	 $('td:eq(16)', nRow).html('<a href="RepairUpdateController?action=edit&cat=UR&id='+aData[0]+'">SR</a>');
                }
                $('td:eq(15)', nRow).html('<a href="UnderRepairController?action=edit&id='+aData[0]+'&qid='+qid+'">Update</a>');

                
              //  $('td:eq(15)', nRow).html('<a href="UnderRepairController?action=edit&id='+aData[0]+'&qid='+qid+'">Update</a> | <a href="UnderRepairController?action=edit&qid='+qid+'">'rp'</a>');  
               // $('td:eq(16)', nRow).html(aData[1]); 
                return nRow;  
            },  
} );
