...
%>
        ...
        session=request.getSession();
            ...
            int userid=(Integer)session.getAttribute("loguserid");
        ...
        <div id="page-wrapper">
            <div class="row">
                ...
                <!-- /.col-lg-12 -->
                <a href="ServiceCopyController?userid=<%=userid%>" method="get" class="btn btn-success" style="margin-left: 15px; margin-bottom: 15px; margin-top: -6px;">Get Pervious</a>
            </div>
            <!-- /.row -->
            <div class="row">
                <div class="col-lg-12">
                                    ...
                                    <%
                                            ...
                                            { 
                                                service_master d=(service_master)request.getAttribute("editablerecord");
                                                        ...
                                                        System.out.println(" the product model issssss"+productModel);
...
//                                                divisio=EmployeeDao.getAllDivi();
                                     ...
                                     <%
                                            ...
                                            <div class="form-group required">
                                            <label class="control-label"> Division</label>
                                            <input type="text" name="division" class="form-control"  id="division" value="<%=division%>" readonly>
                                        </div>
                                     <%
                                                }
                                     %>
                                        ...
                                        <div class="form-group required">
                                            ...
                                            <%
                                                Emploeemaster e;
                                                int eeid=Integer.parseInt(session.getAttribute("loguserid").toString());
                                           
                                             String ename=EmployeeDao.getEmpName(eeid);
                                                    %>
                                                     <option value="<%=eeid%>"><%=ename%></option>
                                                    <%
                                        ...
                                        <div class="form-group required">
                                            ...
                                            <input type="text" name="frn_no" min="1" max="50" class="form-control" value="<%=frnNo%>"  required>
                                        </div>
                                        
                                        <div class="form-group">
                                            <label>FRN DATE<span style="color:red">*</label>
                                            <input type="text" name="frn_date" id = "datepicker-2" class="form-control" value="<%=frnDate%>" required='true' onkeydown="javascript:preventInput(event);" onpaste="return false;">
                                        </div>
                                        
                                           
                                        <div class="form-group">
                                            <label>SER COMM INWARD DATE<span style="color:red">*</label>
                                            <input type="text" name="ser_comm_inward_date" id = "datepicker-1" class="form-control" value="<%=serCommInwardDate%>" required="true" onpaste="return false;">
                                        </div>
                                        
                                        <div class="form-group">
                                            <label>RECEIVED DATE SER CENTRE<span style="color:red">*</label>
                                            <input type="text" name="receive_date_ser_centre" id = "datepicker-3" class="form-control" value="<%=serCentreReceivedDate%>" required="true" onpaste="return false;">
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" name="regionselect" onchange="fetch_dealer(); fetch_branch();fetch_engineer()" value="<%=region%>" required>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select id="myengineer" class="form-control" name="engineerselect"  value="<%=raEngnr%>" >
                                       ...
                                       <div class="form-group">
                                         ...
                                         <div class="form-group">
                                                ...
                                                <select class="form-control" name="sup" id="suplier" onchange="fetch_model()"  required>
...
//                                                      int sid=0;
                                                      String suname="";
                                                    List<Model> sulist=ModelDao.getAllSupp();
                                            if(sulist!=null)
                                            {
                                                Iterator sitr=sulist.iterator();
                                                while(sitr.hasNext())
                                                {
...
//                                                   sid=d.getModelId();
                                                   ...
                                                   if(supplierName=="")
                                                   {
                                                   %>  <option value="<%=suname%>"><%=suname%></option><%
                                ...
                                <div class="col-lg-4">
                                        ...
                                        <div class="form-group">
                                                     ...
                                                     if(mlist!=null)
                                            {
                                                ...
                                                while(mitr.hasNext())
                                                {
                                                   ...
                                                   mid=m.getModelId();
                                                  // System.out.println(mid+" the mid isss");
                                     ...
                                     <div class="form-group">
                                        ...
                                        <div class="form-group">
                                         ...
                                         <div class="form-group">
                                            <label>DOD</label>
                                            <input  name="dod" min="1" max="50" id = "test22" class="form-control" value="<%=dod%>" > 
                                        </div>
                                        ...
                                        <div class="form-group">
                                          ...
                                          <%-- <div class="form-group">
                                            ...
                                            <label>COMPATIBLE MODEL<span style="color:red">*</label>
                                            <input name="mod_name" type="text" min="1" max="50" value="<%=ModBrdName%>"  class="form-control" required>
                                        </div> --%>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input name="def_name" type="text" min="1" max="50" id="brd_name3" value="<%=defModBrdName%>" class="form-control"  required>
                                        </div>
     ...
     /*    session=request.getSession();
            ...
            {   
                %><div class="form-group">
                                            ...
                                            <label>Cost</label>
                                            <input name="cost" type="text" min="1" max="50" id="brd_name2" value="<%=cost%>" class="form-control">
                                        </div><%
     }%>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" name="def_type" id = "def_type"  required>
                                       ...
                                       <div class="form-group">
                                            ...
                                            <input name="def_gir_no" type="text" id="defgir" min="1" max="50" value="<%=defGirNo%>" onkeyup="changeupper()" class="form-control" required>
                                        </div>
                                        <div class="form-group">
                                            <label>REP TYPE<span style="color:red">*</label>
                                            <select class="form-control" id="rep_type" name="rep_type" value="<%=repType%>" onchange="changefun4();changefun3();changefun1();changefun_save()" required>
                                ...
                                <div class="col-lg-4">
                                         ...
                                         <div class="form-group">
                                            ...
                                            <input name="rep_gir_sno" id="repgir" type="text" min="1" max="50" value="<%=repGirNo%>" onKeyup="changeupper();changefun4();changefun1();changefun_save()" class="form-control">
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" name="type_work" id="work_type" value="<%=typeOfWork%>" onchange="changefun_scrapp();changefun_save();changefun6()" required>
                                      ...
                                      <%--   <div class="form-group">
                                            ...
                                            <input name="ship_date" type="text"   id = "datepicker-13" class="form-control"  value="<%=shipDtFrmSerCntr%>" onchange="shipDate()"  >
                                        </div> --%>
                                        <div class="form-group">
                                            <label>SHIP DATE FROM SERVICE CENTER<span style="color:red" class="label3">*</label>
                                            <input name="ship_date" type="text" id = "datepicker-13"  class="form-control" value="<%=shipDtFrmSerCntr%>"   >
                                        </div>
                                        <%-- <div class="form-group">
                                            <label>DISP ADVICE NO</label>
                                            <input name="disp_advice_no" id="disp" type="text" min="1" max="50" value="<%=dispAdvNo%>" class="form-control" readonly="">
                                        </div> --%>
                                       <%--  <div class="form-group">
                                            <label>REPAIRED BRD STK DATE</label>
                                            <input name="repair_stk_date" type="text"  id = "datepicker-15" onchange="repairedDate()" class="form-control"  value="<%=repairedBrdStkDate%>"  >
                                        </div>  --%>
                                         <div class="form-group">
                                            <label>REPAIRED BRD STK DATE<span style="color:red" class="label4">*</label>
                                            <input name="repair_stk_date" type="text" id = "datepicker-15"  class="form-control" value="<%=repairedBrdStkDate%>"  >
                                        </div>
                                      <%--   <div class="form-group">
                                            <label>STOCK ADV NO</label>
                                            <input name="repaired_brd_adv_no" id="stock" type="text" value="<%=repairedBrdAdvNo%>" class="form-control" readonly="">
                                        </div> --%>
                                        <div class="form-group">
                                            <label>SHIP DATE FROM COMMERCIAL<span style="color:red" class="label5">*</label>
                                            <input name="commercial_date" type="text" id = "datepicker-16" onchange="commercialDate()" class="form-control" value="<%=shipDateFromCommercial%>"   >
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input name="dc_no" id="dcno" type="text" min="1" max="50" value="<%=dcNo%>"  class="form-control" >
                                        </div>
                                         <div class="form-group">
                                            <label>TYPE OF REPORT<span style="color:red">*</label>
                                            <select class="form-control" name="report_type" id="report_type" value="" onchange="changefun1();changefn();changefun_scrapp()" required>
...
//        setTimeout(function(){fetch_engineer();},1000); 
    ...
    {
        var request=new XMLHttpRequest();
        var mod=document.vinform.sup.value;
        var url="getmodel.jsp?val="+mod;
        ...
        {  
            ...
            {  
                ...
                {  
                    ...
                    document.getElementById('fmodel').innerHTML=val;
...
//    alert(cat);
    if (cat == "5" || cat=="7") {
      if (document.getElementById("test22").required = 'true') {
...
function Select()
{
    ...
    else
    {
      ...
      function selectsparepart(){
    	...
    	//  alert("s1"+s1);
    	  ...
    	  var url1="getsapare_parts"; 
    	  var url2="getsapare_parts?val="+s1; 
    	        ...
    	        success: function(data) {
    	        	alert(data);
    	        	 $.each(data, function(key, value){
    	        		 $("def_name").val(value.brd_name); // Create HTML <option> element, set its value with currently iterated key and its text content with currently iterated item and finally append it to the <select>.
                         $("comp_models").val(value.comp_models);
                         $("cost").val(value.cost);
    	            });
    	           
    	        }
    	    }); */
    	  $.get(url2, function(responseJson) { 
    		...
    		//  alert("success");
    		  ...
    		  $.each(responseJson, function(key, value){
    			 ...
    			 // alert(value.length);
    			  $("#brd_name"+i+"").val(value);
    			  i++;
    			//  alert(i);
    			 // $("#comp_models").val(value);
    			  
	        		// $("#def_name").val(value); 
	        		 //document.getElementById('def_name').innerHTML=value;
	        		// document.getElementById("def_name").value=value;// Create HTML <option> element, set its value with currently iterated key and its text content with currently iterated item and finally append it to the <select>.
                 // $("#comp_models").val(value.comp_models);
                 //$("#cost").val(value.cost);
    ...
    function changefn(){
    	//  alert("its workingg");
    	  ...
    	  var value1=$("#rep_type").val();
    	  $('.label4').hide();
    	  $('.label1').hide();
    	  //alert(value);
    	  if(value=="servicecenter"&&value1==60){
    	//  alert("yess");
    	...
    	/*   $('.repdiv').hide();
    	  $('.repdiv2').show(); */
      }else  if(value=="servicecenter"&&(value1!=60)){
    	  ...
    	  else if(value=="scraplist"||value=="stocklist"){
      ...
      function changefn3(){
    	...
    	//  alert(value);
    	  if(value==56 && gir==""){
    		 // alert("yes11");
    		//alert(  $('.opt1').val()+" the 1st opt iss");
    		 $('.label1').hide();
    		 document.getElementById("repgir").required = false;
    		 $('.opt2').hide();
    		 $('.opt4').hide();
    	...
    	//  alert("in save");
    	 ...
    	 // alert(type+"type iss");
    	  ...
    	  if((s1==60)&&(type==25||type==23)){
    		//  alert("c0");
    		  $('.save1').show();
    	  }else if((s1==56)&&(gir=='')&&(type==25||type==61)){
    		 // alert("c1");
    		  $('.save1').show();
     ...
     var x2=	$("#defgir").val().toUpperCase();
      ...
      function sparelistfn2(){
    	//  alert("keypress");
    	  var request=new XMLHttpRequest();
    	    var name=document.vinform.regionselect.value;  
    	   
    	        var url="sparelist.jsp";  
