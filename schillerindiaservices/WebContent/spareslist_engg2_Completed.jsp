...
else
{
  ...
  %>
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h3 class="page-header">Spares List</h3>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <div class="col-lg-10">
                    
                     <form role="form" action="ExportSpares_EnggController1" method="post">
                ...
                %>
                                ...
                                <a href="spares_request_form.jsp">
...
<!-- <script src="https://ajax.googleapis.com/ajax/libs/jquery/2.1.4/jquery.min.js"></script>  -->
  ...
  <!--    <script src="dist/js/sb-admin-2.js"></script> -->
    ...
    var table= $('#dataTables-example').DataTable( {
        "processing": true, 
        "serverSide": true,
        "ajax":  "SparesEngg_PageController_Completed",
        "fnRowCallback": function( nRow, aData, iDisplayIndex ) {  
//                $('td:eq(1)', nRow).html(aData[1]);  
                var qid=document.getElementById("qid").value;
//                 $('td:eq(10)', nRow).html('<a href="CallRegUpdate.jsp">Update</a>'); 
               // $('td:eq(11)', nRow).html('<a href="spares_service_commercial_controller?action=edit&id='+aData[0]+'">Update</a>');  
                return nRow;  
            },  
} );
