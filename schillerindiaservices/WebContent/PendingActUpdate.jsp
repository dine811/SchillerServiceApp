                            ...
                            <div class="row">
                                <form role="form" action="PendingActivityController" method="post">
                                    ...
                                    int lid=Integer.parseInt(session.getAttribute("loguserid").toString());
                                            ...
                                            {
                                            Pendingactmaster cr=(Pendingactmaster) request.getAttribute("pendingrecord");
                                            id=cr.getId();
                                            init_date=cr.getInitiateDate();
                                            model=cr.getModel();
                                            pend_act=cr.getPendingActivity();
                                            responsible=cr.getResponsible();
                                            pending_form=cr.getPendingForm();
                                            tar_col_date=cr.getTarClosedDate();
                                            remark=cr.getRemarks();
                                            sc_engg=cr.getScEngg();
                                            div=cr.getDivision();
                                            status=cr.getStatusType();
                                            closed_Date=cr.getClosedDate();
                                            sc_inchrg_remarks=cr.getScInchargeRemark();
                                    ...
                                    %>
                                        ...
                                        <div class="col-lg-4">
                                            <%
                                                ...
                                                <input type="text" name="pending_activity" value="<%=pend_act%>" min="1" max="500" class="form-control">
                                            </div>
                                                    <%
                                                        }else{
                                                        %>
                                                        <div class="form-group">
                                                <label>Description</label>
                                                <input type="text" name="pending_activity" value="<%=pend_act%>" min="1" max="500" class="form-control" readonly="">
                                            </div>
                                                        <%
                                                            }
                                                            %>
                                            ...
                                            <%
                                                ...
                                                <input type="text" name="responsible" value="<%=responsible%>"  min="1" max="250"  class="form-control">
                                            </div>
                                                    <%
                                                        }else{
                                                        %>
                                                        <div class="form-group">
                                                <label>Responsible</label>
                                                <input type="text" name="responsible" value="<%=responsible%>"  min="1" max="250"  class="form-control" readonly="">
                                            </div>
                                                        <%
                                                            }
                                                            %>
                                             ...
                                             <div class="form-group">
                                                ...
                                                <input type="text" name="pending_form" value="<%=pending_form%>"  min="1" max="250" class="form-control">
                                            </div>
                                               <%
                                                    if(role.equalsIgnoreCase("admin")||role.equalsIgnoreCase("ViceChancellor"))
                                                    {
                                                ...
                                                <input type="text" name="tar_closed_date" id="datepicker-2"  value="<%=tar_col_date%>" id="datepicker-2" value="" class="form-control" >
                                        </div>
                                                    <%
                                                        }else{
                                                        %>
                                                        <div class="form-group">
                                                <label>Target Date</label>
                                                <input type="text" name="tar_closed_date"  value="<%=tar_col_date%>"  class="form-control" readonly="" >
                                        </div>
                                                        <%
                                                            }
                                                            %>
                                        ...
                                        <div class="col-lg-4">
                                           ...
                                           <%
                                            ...
                                            if(role.equalsIgnoreCase("admin")||role.equalsIgnoreCase("ViceChancellor")){
                                                ...
                                                <input type="text" name="sc_inchrg_remarks" min="1" max="500"  class="form-control"  >
                                        </div>
