...
<head>
    ...
    <title>Repair Activity_UR</title>
...
else
{
  ...
  %>
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h3 class="page-header">Repair Activity List UR</h3>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
                ...
                <div class="col-lg-10">
                     ...
                     <form role="form" action="RepairExport_Controller" method="post">
                                        ...
                                        <input  type="hidden" name="status" value="pending"/> 
                                          <input  type="hidden" name="cat" value="UR"/>  
...
<!--    <script>
    ...
    var table= $('#dataTables-example').DataTable( {
        "processing": true, 
        "serverSide": true,
        "ajax":  "RepairAct_Controller_UR",
        "fnRowCallback": function( nRow, aData, iDisplayIndex ) {  
//                $('td:eq(1)', nRow).html(aData[1]);  
                var qid=document.getElementById("qid").value;
//                 $('td:eq(10)', nRow).html('<a href="CallRegUpdate.jsp">Update</a>'); 
                $('td:eq(9)', nRow).html('<a href="Repair_UpdateController?action=edit&cat=UR&id='+aData[0]+'">Update</a>');  
                return nRow;  
            },  
} );
